 ...
 */
export function emitAdStyles(panel) {
...
.w-point { display: block; font-size: 28rpx; color: ${tp}; line-height: 1.6; padding: 6rpx 0; }

.w-fact { display: flex; justify-content: space-between; align-items: baseline;
  padding: 18rpx 0; border-bottom: 1rpx solid ${line}; }
.w-fact-label { font-size: 26rpx; color: ${ts}; }
.w-fact-value { font-size: 28rpx; color: ${tp}; font-weight: 600; }

.w-steps { display: flex; flex-direction: column; gap: 18rpx; padding: 12rpx 0; }
.w-step { display: flex; align-items: flex-start; gap: 22rpx; }
.w-step-no { width: 42rpx; height: 42rpx; border-radius: 50%; background: ${accent}; color: #fff;
  font-size: 22rpx; font-weight: 700; text-align: center; line-height: 42rpx; flex: none; }
.w-step-txt { font-size: 28rpx; color: ${tp}; line-height: 1.5; }

.w-coupon { border: 3rpx dashed ${surface}; border-radius: 26rpx; padding: 30rpx;
  text-align: center; margin: 16rpx 0; }
.w-coupon-code { display: block; font-size: 44rpx; font-weight: 800; color: ${surface}; letter-spacing: 3rpx; }
.w-coupon-desc { display: block; font-size: 26rpx; color: ${tp}; margin-top: 8rpx; }

.w-consent { display: block; font-size: 22rpx; color: ${ts}; line-height: 1.6;
  background: ${card}; border-radius: 20rpx; padding: 22rpx 24rpx; margin: 16rpx 0; }

.w-offer { display: flex; justify-content: space-between; align-items: center;
  padding: 24rpx 0; border-bottom: 1rpx solid ${line}; }
.w-offer-title { font-size: 28rpx; color: ${tp}; font-weight: 600; }
.w-offer-reward { font-size: 24rpx; color: ${accent}; }

.w-product { background: ${card}; border-radius: 26rpx; padding: 24rpx; margin-bottom: 16rpx; }
.w-product-name { display: block; font-size: 26rpx; color: ${tp}; line-height: 1.4; }
.w-product-price { display: block; font-size: 32rpx; color: ${tp}; font-weight: 700; margin-top: 8rpx; }

.w-dismiss { display: flex; justify-content: flex-end; padding: 16rpx 0; }
.w-dismiss-txt { font-size: 26rpx; color: ${ts}; }
`;
}
